...
from app.governance.models import (
    ...
    Vote, VoteCreate, VoteChoice, ProposalFinalize
)
...
class GovernanceService:
    ...
    def activate_proposal(self, proposal_id: str, voting_duration_days: int = 7) -> Optional[Proposal]:
        """
    ...
    def cast_vote(self, vote_data: VoteCreate) -> Optional[Vote]:
        ...
        weighted_vote = self._calculate_weighted_vote(
            vote_data.reputation,
            settings.governance_quadratic_scaling
        )
    ...
    def finalize_proposal(self, finalize_data: ProposalFinalize) -> Optional[Proposal]:
        ...
        if total_votes == 0:
            ...
            yes_ratio = proposal.yes_votes / (proposal.yes_votes + proposal.no_votes) if (proposal.yes_votes + proposal.no_votes) > 0 else 0
    ...
    def get_votes_for_proposal(self, proposal_id: str) -> List[Vote]:
        ...
        """
        return [
            vote for vote in self._votes.values()
